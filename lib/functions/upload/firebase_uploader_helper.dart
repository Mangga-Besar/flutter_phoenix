...
import 'package:flutter_phoenix/functions/upload/base_uploader_helper.dart';
...
class FirebaseUploaderHelper extends BaseUploaderHelper {
  ...
  Future<void> upload() async {
    ...
    final fileName = name!.replaceAll(" ", "") +
        DateFormat("yyMMdd_HH:mm:ss").format(DateTime.now());
  ...
  String contentTypeByFilename(String filename) {
    ...
    final defaultType = "application/octet-stream";
